local library = {
	...
	colors = {
		main = Color3.fromHex('00FFE3'),--a6f4f0
		...
		section = Color3.fromHex('00FFE3'), -- 
		otherElementText = Color3.fromHex('00FFE3'),
		elementText = Color3.fromHex('BFBFBF'),
		elementBorder = Color3.fromHex('003030'),
...
function library:CreateWindow(options, ...)
	...
	function windowFunctions:CreateDesigner(options, ...)
		...
		}}, {"AddButton", "__Designer.Label.Version", settingssection, {
			Name = "Check Bugs",
		...
		detailssection:AddToggle({
			Name = 'White Screen',
			Value = _G.White_Screen,
